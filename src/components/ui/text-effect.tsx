...
/**
 * Samsung-style Tech Effect (Vietnamese)
 */
...
/**
 * Samsung-style Tech Effect (English)
 */
...
/**
 * Systemic Generic Text Effect
 * Applies the 'tech' spring physics and staggered animation to any string.
 */
    ...
    return (
        ...
        >
            {words.map((word, wordIdx) => (
                <span key={wordIdx} className="inline-flex shrink-0 whitespace-nowrap">
                    ...
                    {/* Natural space for natural wrapping */}
